...
func TestParseEndpoints(t *testing.T) {
	testCases := []struct {
		...
		// Invalid inputs
		{"rediss://localhost:2379,redis://localhost:2380", nil, false, false},
		{",,,", nil, false, false},
		{"", nil, false, false},
		{"ftp://localhost:2379", nil, false, false},
		{"redis://localhost:2379000", nil, false, false},

		// Valid inputs
		{
			"rediss://localhost:2379,rediss://localhost:2380",
			[]string{
				"localhost:2379", "localhost:2380",
			},
			true, true,
		},
		{"redis://localhost:2379", []string{"localhost:2379"}, false, true},
	}
